...
$SteamAPIKey = "3048CDBEF5E4A86F024BD5229F6236A5";
...
<html>
    ...
    <div class="core-wrapper"><!-- Opens the wrapper so we can contain and center everything -->
        ...
        <div id="right-items"><!-- Open wrapper for the items on the right -->
            ...
            <div class="title">
            	<h2>Our Core Rules</h2><!-- Adds in the rules title, you can change the text to be whatever you would like -->
           	</div>
            
            <!-- Let's add in all the rules, the number inside the <span></span> tags will appear in a brighter coloured box  -->
            <ul id="rules">
            	<li><span>1</span> English only, other languages may result in a kick</li>
                <li><span>2</span> Do not purposefully harm the server/gameplay</li>
                <li><span>3</span> Do not share links with malicious intent</li>
                <li><span>4</span> Respect all players, including staff on duty</li>
                <li><span>5</span> Do not advertise other servers or establishments</li>
                <li><span>6</span> Do not promote religious or political viewpoints OOC</li>
                <li><span>7</span> Do not promote NSFW or NSFL content</li>
                <li><span>8</span> Do not spam text or voice chat with malicious intent</li>
                <li><span>9</span> All staff administrate equally</li>
                <li><span>10</span> For more rules do !rules in-game</li>
            </ul>
